        ...
        <div className="min-h-screen bg-background text-text">
            ...
            <section className="min-h-screen pt-32 pb-16 flex flex-col items-center justify-center text-center px-4 relative">
                ...
                <div
                    ...
                    style={{
                        background:
                            "radial-gradient(ellipse 60% 40% at 50% -10%, var(--primary) 0%, transparent 80%), radial-gradient(ellipse 50% 30% at 90% 90%, var(--primary-dim) 0%, transparent 60%)",
                    }}
                />
                ...
                <div className="absolute inset-0 overflow-hidden pointer-events-none">
                    ...
                    <div className="absolute hidden lg:flex items-center left-[8%] top-[20%] w-36 pointer-events-auto animate-float-3d-1">
                        <img
                            src="/calculator_3d.png"
                            alt="3D Calculator"
                            loading="lazy"
                            decoding="async"
                            className="w-full h-auto object-contain drop-shadow-[0_10px_25px_rgba(56,189,248,0.12)]"
                        />
                    </div>
                    ...
                    <div className="absolute hidden lg:flex items-center right-[8%] top-[23%] w-36 pointer-events-auto animate-float-3d-2">
                        <img
                            src="/id_badge_3d.png"
                            alt="3D Student ID Card"
                            loading="lazy"
                            decoding="async"
                            className="w-full h-auto object-contain drop-shadow-[0_10px_25px_rgba(52,211,153,0.12)]"
                        />
                    </div>
                    ...
                    <div className="absolute hidden lg:flex items-center left-[10%] bottom-[28%] w-36 pointer-events-auto animate-float-3d-3">
                        <img
                            src="/magnifying_glass_3d.png"
                            alt="3D Magnifying Glass"
                            loading="lazy"
                            decoding="async"
                            className="w-full h-auto object-contain drop-shadow-[0_10px_25px_rgba(251,191,36,0.12)]"
                        />
                    </div>
                    ...
                    <div className="absolute hidden lg:flex items-center right-[9%] bottom-[22%] w-36 pointer-events-auto animate-float-3d-4">
                        <img
                            src="/drafter_tool_3d.png"
                            alt="3D Drafting Tool"
                            loading="lazy"
                            decoding="async"
                            className="w-full h-auto object-contain drop-shadow-[0_10px_25px_rgba(244,63,94,0.12)]"
                        />
                    </div>
                </div>
                ...
                <p className="max-w-2xl text-base sm:text-lg text-text-muted mx-auto mt-8 mb-14 leading-relaxed z-10 animate-in fade-in duration-700">
                    AI-powered lost & found and a borrowing platform built for
                    modern campuses.
                </p>
                        ...
                        <div className="flex justify-between items-center border-b border-border/50 pb-3 md:pb-4 mt-2 md:mt-0">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="font-display font-[800] text-sm text-primary">
                                    Retrieval
                                    <span className="text-text">Co.</span>
                                </span>
                            </div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div
                                    className="w-6 h-6 rounded-full flex items-center justify-center font-display font-bold text-[9px] text-white"
                                    style={{
                                        background:
                        ...
                        <div className="grid grid-cols-12 gap-4 md:gap-6 text-left items-start relative flex-1">
                            ...
                            <div className="hidden md:flex col-span-4 flex-col gap-4 border-r border-border/30 pr-4">
                                <div className="flex flex-col gap-1.5">
                                    ...
                                    <div className="flex gap-1.5 flex-wrap">
                                        <div className="px-2 py-1 rounded-full bg-primary text-white text-[8px] font-semibold">
                                            All Items
                                        </div>
                                        <div className="px-2 py-1 rounded-full bg-surface border border-border text-text-muted text-[8px]">
                                            Today's
                                        </div>
                                        <div className="px-2 py-1 rounded-full bg-surface border border-border text-text-muted text-[8px]">
                                            Urgent
                            ...
                            <div className="col-span-12 md:col-span-8 flex flex-col gap-4 relative w-full">
                                ...
                                <div className="glass-panel border-l-[3px] border-l-danger rounded-lg p-4 flex flex-col gap-2 relative bg-surface/20">
                                    <div className="flex justify-between items-center">
                                        <div className="flex items-center gap-1.5">
                                            <span className="px-1.5 py-0.5 text-[8px] font-bold uppercase tracking-wider rounded bg-danger text-white">
                                                Lost
                                            </span>
                                            <span className="px-1.5 py-0.5 text-[8px] font-bold uppercase tracking-wider rounded bg-zinc-800 text-text-muted border border-border">
                                                Open
                                            </span>
                                            <span className="px-1.5 py-0.5 text-[8px] font-bold uppercase tracking-wider rounded bg-danger/10 text-danger border border-danger/25">
                                                Urgent
                                            </span>
                                        </div>
                                    ...
                                    <h4 className="text-xs font-display font-bold text-text">
                                        Lost iPhone 14 Pro
                                    </h4>
                                    <p className="text-text-muted text-[10px] leading-relaxed line-clamp-1">
                                        Slipped from my pocket near the canteen.
                                        Blue color in a black case.
                                    </p>
                                    <div className="flex justify-between items-center border-t border-border/40 pt-2 mt-1">
                                        <div className="flex items-center gap-1.5 text-[9px] text-text-muted">
                                            <span
                                                className="w-4 h-4 rounded-full flex items-center justify-center font-display font-extrabold text-[6px] text-white"
                                                style={{
                                                    background:
                                                        "linear-gradient(135deg, var(--primary), var(--primary-dim))",
                                                }}
                                        ...
                                        <div className="flex gap-1.5">
                                            <div className="px-2.5 py-1 rounded bg-primary text-white text-[9px] font-bold">
                                                Reply
                                            </div>
                                            <div className="px-1.5 py-1 rounded bg-surface border border-border text-[9px] text-text flex items-center justify-center">
                                                <QrCode size={10} />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    {step >= 1 && (
                                        <div className="bg-primary-dim/10 border border-primary-dim/20 rounded-lg px-2.5 py-2.5 text-[10px] text-primary-dim flex items-center gap-1.5 mt-1.5 animate-in slide-in-from-top duration-300">
                                            <Sparkles
                                                size={11}
                                                className="text-primary-dim animate-spin"
                                            />
                                            <span>
                                ...
                                <div className="glass-panel rounded-lg p-4 flex flex-col gap-2 relative bg-surface/20">
                                    <div className="flex justify-between items-center">
                                        <div className="flex items-center gap-1.5">
                                            <span className="px-1.5 py-0.5 text-[8px] font-bold uppercase tracking-wider rounded bg-success text-white">
                                                Found
                                            </span>
                                            <span className="px-1.5 py-0.5 text-[8px] font-bold uppercase tracking-wider rounded bg-zinc-800 text-text-muted border border-border">
                                                Open
                                    ...
                                    <p className="text-text-muted text-[10px] leading-relaxed line-clamp-1">
                                        Found a set of keys near the library
                                        desk. One key has a red rubber cap.
                                    </p>
                                    <div className="flex justify-between items-center border-t border-border/40 pt-2 mt-1">
                                        <div className="flex items-center gap-1.5 text-[9px] text-text-muted">
                                            <span
                                ...
                                <div className="absolute inset-0 bg-background/70 backdrop-blur-md flex items-center justify-center z-30 animate-in fade-in zoom-in-95 duration-300">
                                    <div className="glass-panel border border-border shadow-modal rounded-xl p-5 bg-card w-80 text-left flex flex-col gap-3">
                                        <div className="flex justify-between items-center border-b border-border/50 pb-2">
                                            ...
                                            <span className="px-1.5 py-0.5 text-[8px] bg-danger text-white rounded font-bold uppercase">
                                                Lost
                                            </span>
                                        </div>
                                        <div>
                                            ...
                                            <div className="text-xs text-text font-bold bg-surface p-2 rounded border border-border mt-1">
                                                iPhone 14 Pro
                                            </div>
                                        </div>
                                        <div>
                                ...
                                <div className="absolute inset-0 bg-background/70 backdrop-blur-md flex items-center justify-center z-30 animate-in fade-in zoom-in-95 duration-300">
                                    <div className="glass-panel border border-border shadow-modal rounded-xl p-5 bg-card w-80 text-left flex flex-col gap-3">
                                        <div className="flex justify-between items-center border-b border-border/50 pb-2">
                                            ...
                                            <span className="px-1.5 py-0.5 text-[8px] bg-primary text-white rounded font-bold uppercase">
                                                Borrow
                                            </span>
                                        </div>
                                        <div>
                                    ...
                                    <div className="glass-panel border border-border shadow-modal rounded-xl p-5 bg-card w-80 text-center flex flex-col items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[10px] text-text-muted mt-1 leading-relaxed px-2">
                                                Our live database successfully
                                                matched:
                                            </p>
                                            <div className="flex flex-col gap-2 mt-2 w-64">
                                                <div className="bg-surface border border-border rounded-lg px-3 py-2 text-[10px] text-text flex items-center justify-between gap-1">
                                                    ...
                                                    <div className="flex-grow h-[1px] bg-border mx-2 relative overflow-hidden">
                                                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-primary/10 text-primary border border-primary/30 rounded-full px-1 py-0.5 text-[6px] font-extrabold tracking-wider">
                                                            AI
                                                        </div>
                                                    </div>
                                ...
                                <div className="absolute inset-0 bg-background/70 backdrop-blur-md flex items-center justify-center z-30 animate-in fade-in zoom-in-95 duration-300">
                                    <div className="glass-panel border border-border shadow-modal rounded-xl p-5 bg-card w-80 text-center flex flex-col items-center gap-3">
                                        ...
                                        <p className="text-[10px] text-text-muted leading-relaxed">
                                            Verification complete! Items
                                            successfully returned and handoffs
                                            verified. +Karma Points awarded!
                                        </p>
            ...
            <section
                id="features"
                className="py-32 px-4 md:px-8 max-w-6xl mx-auto scroll-mt-24"
            >
                        ...
                        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-5 gap-6 items-center h-full">
                            <div className="lg:col-span-3 flex flex-col gap-4">
                                ...
                                <p className="text-text-muted text-[13px] leading-relaxed">
                                    Deep semantic parsing connects lost posts
                                    with found log records in real time. We
                                    match locations, visual descriptions, and
                                    item properties automatically.
                                </p>
                            </div>
                    ...
                    <div className="glass-panel p-6 rounded-xl relative overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:border-zinc-500 group flex flex-col justify-between min-h-[280px]">
                        <div className="flex flex-col gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-text-muted text-[13px] leading-relaxed">
                                    Coordinate borrows based on class schedules.
                                    Align meetup times effortlessly between
                                    classes.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="glass-panel p-6 rounded-xl relative overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:border-zinc-500 group flex flex-col justify-between min-h-[280px]">
                        <div className="flex flex-col gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-text-muted text-[13px] leading-relaxed">
                                    Verifies returns securely with dual-scan QR
                                    confirmation, guaranteeing the item goes to
                                    the right owner.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="bg-surface/60 border border-border/60 rounded-lg p-2 relative overflow-hidden flex items-center justify-center w-full h-16 mt-4">
                            <QrCode
                                size={30}
                                className="text-primary-dim opacity-70"
                            />
                    ...
                    <div className="glass-panel p-6 rounded-xl relative overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:border-zinc-500 group flex flex-col justify-between min-h-[280px]">
                        <div className="flex flex-col gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-text-muted text-[13px] leading-relaxed">
                                    Report lost, found, or borrow items in
                                    seconds with visual photo uploads and
                                    automated tags.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="glass-panel p-6 rounded-xl relative overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:border-zinc-500 group flex flex-col justify-between min-h-[280px]">
                        <div className="flex flex-col gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-text-muted text-[13px] leading-relaxed">
                                    Earn karma points, claim achievements, and
                                    climb the campus leaderboard for helpful
                                    behavior.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="glass-panel p-6 rounded-xl relative overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:border-zinc-500 group md:col-span-3">
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-center">
                            <div className="lg:col-span-2 flex flex-col gap-3 text-left">
                                ...
                                <p className="text-text-muted text-[13px] leading-relaxed">
                                    Visualizes lost items using AI campus
                                    heatmaps. Avoid high-loss zones and secure
                                    your items.
                                </p>
                            </div>
