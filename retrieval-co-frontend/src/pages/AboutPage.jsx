            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="text-center mb-20">
                    ...
                    <p className="text-text-muted text-sm md:text-base max-w-2xl mx-auto leading-relaxed">
                        RetrievalCo. is a smart campus platform that helps
                        students recover lost items, borrow resources, and build
                        a more connected community — all powered by AI matching
                        and a trust-based karma system.
                    </p>
                </div>
                ...
                {/* Our Story */}
                <div className="mb-20">
                    <span className="text-xs font-bold tracking-widest uppercase text-primary mb-3 block text-center">
                        Our Story
                    </span>
                    ...
                    <div className="glass-panel rounded-xl border border-border p-8 md:p-10">
                        <div className="flex flex-col gap-5 text-[14px] text-text-muted leading-relaxed">
                            <p>
                                It started with a lost calculator right before a
                                midterm exam. The campus had no centralized
                                system — just scattered WhatsApp groups and
                                notice boards that nobody checked. Items were
                                lost, time was wasted, and the stress kept
                                piling up.
                            </p>
                            <p>
                                ...
                                was born from that frustration. We wanted to
                                create something that wasn't just a digital
                                lost-and-found board, but an intelligent
                                platform that actively helps match items,
                                coordinates handoffs securely, and rewards the
                                people who make campus life better.
                            </p>
                            <p>
                                With AI-powered matching, real-time
                                notifications, QR-verified handoffs, and a
                                karma-based reputation system, RetrievalCo.
                                transforms how campuses handle lost items and
                                resource sharing. Because on a campus of
                                thousands, no one should feel alone when they
                ...
                <div className="text-center">
                    ...
                    <div className="glass-panel rounded-xl border border-border p-8 max-w-md mx-auto hover:border-primary/30 transition-all duration-300">
                        <div
                            className="w-16 h-16 rounded-full mx-auto mb-4 flex items-center justify-center font-display font-bold text-xl text-white"
                            style={{
                                background:
